...
test_that("use beta", {
  ...
  testthat::expect_true(
    beautier:::is_initialized_distr(
      beautier:::initialize_distr(create_beta_distr())
    )
  )
...
test_that("use exponential", {
  ...
  testthat::expect_true(
    beautier:::is_initialized_distr(
      beautier:::initialize_distr(create_exponential_distr())
    )
  )
...
test_that("use gamma", {
  ...
  testthat::expect_true(
    beautier:::is_initialized_distr(
      beautier:::initialize_distr(create_gamma_distr())
    )
  )
...
test_that("use inv_gamma", {
  ...
  testthat::expect_true(
    beautier:::is_initialized_distr(
      beautier:::initialize_distr(create_inv_gamma_distr())
    )
  )
...
test_that("use laplace", {
  ...
  testthat::expect_true(
    beautier:::is_initialized_distr(
      beautier:::initialize_distr(create_laplace_distr())
    )
  )
...
test_that("use log_normal", {
  ...
  testthat::expect_true(
    beautier:::is_initialized_distr(
      beautier:::initialize_distr(create_log_normal_distr())
    )
  )
...
test_that("use normal", {
  ...
  testthat::expect_true(
    beautier:::is_initialized_distr(
      beautier:::initialize_distr(create_normal_distr())
    )
  )
...
test_that("use one_div_x", {
  ...
  testthat::expect_true(
    beautier:::is_initialized_distr(
      beautier:::initialize_distr(create_one_div_x_distr())
    )
  )
...
test_that("use poisson", {
  ...
  testthat::expect_true(
    beautier:::is_initialized_distr(
      beautier:::initialize_distr(create_poisson_distr())
    )
  )
