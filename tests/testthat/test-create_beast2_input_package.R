...
test_that("Nested-Sampling package", {
  # From https://github.com/BEAST2-Dev/nested-sampling:
  #
  # Replace the <run line that says something like
  #
  ...
  testit::assert(line == "<run id=\"mcmc\" spec=\"beast.gss.NS\" chainLength=\"10000000\" particleCount=\"1\" subChainLength=\"5000\" epsilon=\"1e-12\">")
})
