...
test_that("minimal use", {
  ...
  # Fixes babette #106 (https://github.com/ropensci/babette/issues/106)
  expected <- "beast.core:beast.evolution.alignment:beast.evolution.tree.coalescent:beast.core.util:beast.evolution.nuc:beast.evolution.operators:beast.evolution.sitemodel:beast.evolution.substitutionmodel:beast.evolution.likelihood" # nolint
