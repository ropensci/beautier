...
test_that("use, zero monophylies, issue #32", {
  ...
  prior_one_two_three <- create_mrca_prior(
    alignment_id = get_alignment_id(fasta_filename),
    taxa_names = c("B431_aco", "61430_aco", "KU9813_aco", "B87109_aco", "KU25127_aco", "meridae_aco", "UWBM54556_aco", "KU21673_aco", "B25702_aco"),
    is_monophyletic = FALSE
  )
  prior_two_three <- create_mrca_prior(
    alignment_id = get_alignment_id(fasta_filename),
    taxa_names = c("B87109_aco", "B25702_aco", "FALK1_aco", "B431_aco", "630210_aco", "chacoensis_aco", "meridae_aco", "UWBM54556_aco", "B48218_aco", "dabbenei_aco", "KU25127_aco", "B41613_aco", "KU21673_aco", "626029_aco"),
    is_monophyletic = FALSE
  )
  non_intersecting_priors <- list(prior_one_two_three, prior_two_three)
