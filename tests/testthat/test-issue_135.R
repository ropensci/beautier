test_that("1: files were different, are the same now", {
  # The submitted files were not equivalent.
  # This helped fix beautier.
  # Now, a created beautier file 'issue_135_no_mrca_no_estimate_beautier.xml'
  # indeed is correct.
