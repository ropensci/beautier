...
test_that("use", {
  ...
  expect_true(beautier:::is_gamma_site_model(
    create_gamma_site_model())
  )

  expect_false(beautier:::is_gamma_site_model("nonsense"))
  expect_false(beautier:::is_gamma_site_model(NA))
  expect_false(beautier:::is_gamma_site_model(NULL))
})

test_that("devious", {

  g <- create_gamma_site_model()
  expect_true(beautier:::is_gamma_site_model(g))

  # No gamma_cat_count
  h <- g[names(g) != "gamma_cat_count"]
  expect_false(beautier:::is_gamma_site_model(h))
