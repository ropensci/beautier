 ...
 * (optional) an MCRCA prior: a 'Most Recent Common Ancestor'
...
the word 'nucleotide substution' (nor `nsm`) `in it. Instead, it is as if
...
## (optional) MCRCA prior: a 'Most Recent Common Ancestor'
