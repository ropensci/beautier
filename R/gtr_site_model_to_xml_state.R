...
gtr_site_model_to_xml_state <- function(
  ...
  beautier::check_true("estimate" %in% names(site_model$rate_ac_param))
  beautier::check_true("estimate" %in% names(site_model$rate_ag_param))
  beautier::check_true("estimate" %in% names(site_model$rate_at_param))
  beautier::check_true("estimate" %in% names(site_model$rate_cg_param))
  beautier::check_true("estimate" %in% names(site_model$rate_ct_param))
  beautier::check_true("estimate" %in% names(site_model$rate_gt_param))
