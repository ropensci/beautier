...
get_site_model_n_params <- function(
  ...
  gamma_site_model_n_params <- get_gamma_site_model_n_params( # nolint internal function
  ...
  if (is_gtr_site_model(site_model)) { # nolint internal function
    return(
      ...
      get_distr_n_params(site_model$rate_ac_prior_distr) + # nolint internal function
      get_distr_n_params(site_model$rate_ag_prior_distr) + # nolint internal function
      get_distr_n_params(site_model$rate_at_prior_distr) + # nolint internal function
      get_distr_n_params(site_model$rate_cg_prior_distr) + # nolint internal function
      get_distr_n_params(site_model$rate_gt_prior_distr) # nolint internal function
    )
  } else if (is_hky_site_model(site_model)) { # nolint internal function
    return(
      gamma_site_model_n_params +
      get_distr_n_params(site_model$kappa_prior_distr) # nolint internal function
    )
    ...
    return(
      gamma_site_model_n_params +
      get_distr_n_params(site_model$kappa_1_prior_distr) + # nolint internal function
      get_distr_n_params(site_model$kappa_2_prior_distr) # nolint internal function
    )
  }
}
