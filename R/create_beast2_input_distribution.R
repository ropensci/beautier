...
create_beast2_input_distribution <- function(
  ...
  if (is_hky_site_model(site_models)) {
    ...
    text <- c(text, paste0("            <prior id=\"RateACPrior.s:", ids, "\" name=\"distribution\" x=\"@rateAC.s:", ids, "\">"))
    text <- c(text, paste0("                <Gamma id=\"Gamma.0\" name=\"distr\">"))
    text <- c(text, paste0("                    <parameter id=\"RealParameter.7\" estimate=\"false\" name=\"alpha\">0.05</parameter>"))
    text <- c(text, paste0("                    <parameter id=\"RealParameter.8\" estimate=\"false\" name=\"beta\">10.0</parameter>"))
    text <- c(text, paste0("                </Gamma>"))
    text <- c(text, paste0("            </prior>"))
    text <- c(text, paste0("            <prior id=\"RateAGPrior.s:", ids, "\" name=\"distribution\" x=\"@rateAG.s:", ids, "\">"))
    text <- c(text, paste0("                <Gamma id=\"Gamma.1\" name=\"distr\">"))
    text <- c(text, paste0("                    <parameter id=\"RealParameter.9\" estimate=\"false\" name=\"alpha\">0.05</parameter>"))
    text <- c(text, paste0("                    <parameter id=\"RealParameter.10\" estimate=\"false\" name=\"beta\">20.0</parameter>"))
    text <- c(text, paste0("                </Gamma>"))
    text <- c(text, paste0("            </prior>"))
    text <- c(text, paste0("            <prior id=\"RateATPrior.s:", ids, "\" name=\"distribution\" x=\"@rateAT.s:", ids, "\">"))
    text <- c(text, paste0("                <Gamma id=\"Gamma.2\" name=\"distr\">"))
    text <- c(text, paste0("                    <parameter id=\"RealParameter.11\" estimate=\"false\" name=\"alpha\">0.05</parameter>"))
    text <- c(text, paste0("                    <parameter id=\"RealParameter.12\" estimate=\"false\" name=\"beta\">10.0</parameter>"))
    text <- c(text, paste0("                </Gamma>"))
    text <- c(text, paste0("            </prior>"))
    text <- c(text, paste0("            <prior id=\"RateCGPrior.s:", ids, "\" name=\"distribution\" x=\"@rateCG.s:", ids, "\">"))
    text <- c(text, paste0("                <Gamma id=\"Gamma.3\" name=\"distr\">"))
    text <- c(text, paste0("                    <parameter id=\"RealParameter.13\" estimate=\"false\" name=\"alpha\">0.05</parameter>"))
    text <- c(text, paste0("                    <parameter id=\"RealParameter.14\" estimate=\"false\" name=\"beta\">10.0</parameter>"))
    text <- c(text, paste0("                </Gamma>"))
    text <- c(text, paste0("            </prior>"))
    text <- c(text, paste0("            <prior id=\"RateGTPrior.s:", ids, "\" name=\"distribution\" x=\"@rateGT.s:", ids, "\">"))
    text <- c(text, paste0("                <Gamma id=\"Gamma.5\" name=\"distr\">"))
    text <- c(text, paste0("                    <parameter id=\"RealParameter.17\" estimate=\"false\" name=\"alpha\">0.05</parameter>"))
    text <- c(text, paste0("                    <parameter id=\"RealParameter.18\" estimate=\"false\" name=\"beta\">10.0</parameter>"))
    text <- c(text, paste0("                </Gamma>"))
    text <- c(text, paste0("            </prior>"))
  }
  ...
  if (is_jc69_site_model(site_models)) {
    ...
    text <- c(text, paste0("                    <substModel id=\"gtr.s:", ids, "\" spec=\"GTR\" rateAC=\"@rateAC.s:", ids, "\" rateAG=\"@rateAG.s:", ids, "\" rateAT=\"@rateAT.s:", ids, "\" rateCG=\"@rateCG.s:", ids, "\" rateGT=\"@rateGT.s:", ids, "\">"))
    text <- c(text, paste0("                        <parameter id=\"rateCT.s:", ids, "\" estimate=\"false\" lower=\"0.0\" name=\"rateCT\">1.0</parameter>"))
    text <- c(text, paste0("                        <frequencies id=\"estimatedFreqs.s:", ids, "\" spec=\"Frequencies\" frequencies=\"@freqParameter.s:", ids, "\"/>"))
    text <- c(text, paste0("                    </substModel>"))
  }
