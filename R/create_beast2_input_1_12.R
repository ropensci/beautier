...
create_beast2_input_1_12 <- function(
  ...
  if (!are_initial_phylogenies(initial_phylogenies)) { # nolint beautier function
  ...
  site_models <- init_site_models( # nolint beautier function
    site_models = site_models,
    ids = get_alignment_ids(input_filenames), # nolint beautier function
    distr_id = 0,
    param_id = 0
  )  # nolint beautier function
  clock_models <- init_clock_models( # nolint beautier function
    clock_models = clock_models,
    fasta_filenames = input_filenames,
    distr_id = 0 + get_site_models_n_distrs(site_models), # nolint beautier function
    param_id = 0 + get_site_models_n_params(site_models) # nolint beautier function
  )  # nolint beautier function
  ...
  text <- create_beast2_input_beast( # nolint beautier function
