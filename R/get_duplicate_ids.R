...
#'   testit::assert(get_duplicate_ids(c(line_1, line_2) == c("1", "2")))
#'   testit::assert(get_duplicate_ids(c(line_1, line_1) == c("1")))
#'   testit::assert(get_duplicate_ids(c(line_2, line_2) == c("2")))
