...
is_init_distr <- function(
  ...
  if (beautier::is_beta_distr(x)) {
    beautier::is_init_beta_distr(x)
  } else if (beautier::is_exp_distr(x)) {
    beautier::is_init_exp_distr(x)
  } else if (beautier::is_gamma_distr(x)) {
    beautier::is_init_gamma_distr(x)
  } else if (beautier::is_inv_gamma_distr(x)) {
    beautier::is_init_inv_gamma_distr(x)
  } else if (beautier::is_laplace_distr(x)) {
    beautier::is_init_laplace_distr(x)
  } else if (beautier::is_log_normal_distr(x)) {
    beautier::is_init_log_normal_distr(x)
  } else if (beautier::is_normal_distr(x)) {
    beautier::is_init_normal_distr(x)
  } else if (beautier::is_one_div_x_distr(x)) {
    beautier::is_init_one_div_x_distr(x)
  } else if (beautier::is_poisson_distr(x)) {
    beautier::is_init_poisson_distr(x)
  } else {
    beautier::check_true(beautier::is_uniform_distr(x))
    beautier::is_init_uniform_distr(x)
  }
}
...
is_init_beta_distr <- function(
  ...
  beautier::check_true(beautier::is_beta_distr(x))
...
is_init_exp_distr <- function(
  ...
  beautier::check_true(beautier::is_exp_distr(x))
...
is_init_gamma_distr <- function(
  ...
  beautier::check_true(beautier::is_gamma_distr(x))
  !beautier::is_one_na(x$alpha$id) && !beautier::is_one_na(x$beta$id)
}
...
is_init_inv_gamma_distr <- function(
  ...
  beautier::check_true(beautier::is_inv_gamma_distr(x))
  !beautier::is_one_na(x$alpha$id) && !beautier::is_one_na(x$beta$id)
}
...
is_init_laplace_distr <- function(
  ...
  beautier::check_true(beautier::is_laplace_distr(x))
...
is_init_log_normal_distr <- function(
  ...
  beautier::check_true(beautier::is_log_normal_distr(x))
...
is_init_normal_distr <- function(
  ...
  beautier::check_true(beautier::is_normal_distr(x))
...
is_init_one_div_x_distr <- function(
  ...
  beautier::check_true(beautier::is_one_div_x_distr(x))
  TRUE
}
...
is_init_poisson_distr <- function(
  ...
  beautier::check_true(beautier::is_poisson_distr(x))
